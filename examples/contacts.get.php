...
$customersService = new FastBillSdk\Contacts\ContactsService(
    $fastBillClient,
    new \FastBillSdk\Common\XmlService(),
    new \FastBillSdk\Contacts\ContactsValidator()
);
$customersSearchStruct = new \FastBillSdk\Contacts\ContactsSearchStruct();
