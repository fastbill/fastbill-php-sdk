...
$recurringInvoiceEntity->invoiceId = 123321;
...
$recurringInvoiceItem->description = 'FastBill SDK Reccuring Updated';
$recurringInvoiceItem->unitPrice = 1337;
$recurringInvoiceItem->vatPercent = 19;
$recurringInvoiceEntity->items[] = $recurringInvoiceItem;
$recurringInvoiceEntity->items[] = $recurringInvoiceItem;

$result = $recurringInvoiceService->updateRecurringInvoice($recurringInvoiceEntity);
